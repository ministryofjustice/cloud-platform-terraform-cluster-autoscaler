...
| <a name="input_enable_cluster_autoscaler"></a> [enable\_cluster\_autoscaler](#input\_enable\_cluster\_autoscaler) | Enable or disbale creation of cluster autoscaler module | `bool` | `true` | no |
